...
public class ConfigManager {
    ...
    public String getAdvancedLoseParticle1() {
        return config.getString("soul.advanced-effects.lose.particle1", "TRIAL_SPAWNER_DETECTION");
    }

    public String getAdvancedLoseParticle2() {
        return config.getString("soul.advanced-effects.lose.particle2", "FALLING_DUST");
    }
